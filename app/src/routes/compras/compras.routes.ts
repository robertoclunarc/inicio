...
import {
    ...
    insertDetalleSolped,
    updateGenerado,
    getTotalDetallesNoProcess,
    updateDetalle,
    solpedetalledatatodos,
...
import {
    ...
    selectRecordFilter,
    updateRecord,
} from '../../controllers/compras/proveedorescrud.controller';
...
router.get('/api/oc/historico/oc', todasOcHistoricas);
// router.get("/api/aa/h", todasOcHistoricas);
...
router.get(
    '/api/proveedores/filtrar/:Id/:nombre/:rif/:direccion/:valoracion/:telefono/:observaciones/:contacto',
    selectRecordFilter,
);
